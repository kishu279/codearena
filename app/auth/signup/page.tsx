      ...
      <Card className="w-full max-w-md rounded-2xl bg-surface">
        <CardHeader>
          ...
          <p className="mt-2 text-sm text-text-secondary">
            Sign up with a social account or credentials.
          </p>
        </CardHeader>
        ...
        <CardContent>
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            <div className="space-y-2">
              <Label htmlFor="signup-username" className="text-text-secondary">
                Username
              </Label>
              <Input
                id="signup-username"
            ...
            <div className="space-y-2">
              <Label htmlFor="signup-email" className="text-text-secondary">
                Email
              </Label>
              <Input
                id="signup-email"
            ...
            <div className="space-y-2">
              <Label htmlFor="signup-password" className="text-text-secondary">
                Password
              </Label>
              <Input
                id="signup-password"
